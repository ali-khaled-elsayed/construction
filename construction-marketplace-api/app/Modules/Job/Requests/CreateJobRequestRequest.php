...
use App\Modules\Job\Enums\DescriptionType as EnumsDescriptionType;
...
class CreateJobRequestRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'job_type' => ['required', 'in:' . implode(',', JobType::values())],
            'service_type' => ['required', 'in:' . implode(',', ServiceType::values())],
            'description_type' => ['required', 'in:' . implode(',', EnumsDescriptionType::values())],
            ...
            'basic_description.rooms_count' => ['required_if:description_type,basic', 'integer', 'min:1'],
            ...
            'rooms.*.jobs.*.category_id' => ['required_with:rooms.*.jobs', 'exists:job_categories,id'],
            ...
            'jobs' => ['nullable', 'array'],
            'jobs.*.category_id' => ['required_with:jobs', 'exists:job_categories,id'],
